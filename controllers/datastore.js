...
exports.dataStore = (req,res) => {
    ...
    ln.datastore(req.body.dataString ? {string: req.body.dataString, ...clnReq } : clnReq).then(data => {
...
exports.listDatastore = (req,res) => {
    ...
    ln.listdatastore(req.query.key ? {key: req.query.key } : {}).then(data => {
...
exports.delDatastore = (req,res) => {
    ...
    ln.deldatastore({ key: req.params.key, ...(req.query.generation ? {generation: req.query.generation} : {}) }).then(data => {
