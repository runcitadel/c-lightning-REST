...
exports.getRoute = (req, res) => {
  ...
  const rf = 0;
  if (req.query.riskFactor) rf = req.query.riskFactor;
...
exports.listNode = (req, res) => {
  ...
  ln.listnodes({ id: req.params.pubKey })
    .then((data) => {
...
exports.listChannel = (req, res) => {
  ...
  ln.listchannels({ short_channel_id: req.params.shortChanId })
    .then((data) => {
...
exports.feeRates = (req, res) => {
  ...
  ln.feerates({ style: req.params.rateStyle })
    .then((data) => {
...
exports.listNodes = (req, res) => {
  ...
  //Call the listnodes command with the params
  ln.listnodes(req.query.id ? { id: req.query.id } : {})
    .then((data) => {
      global.logger.log("listnodes success");
      res.status(200).json(data.nodes);
    })
